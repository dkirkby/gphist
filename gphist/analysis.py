...
def calculate_histograms(DH,DH0,DA,DA0,f,f0,phi,phi0,de_evol,de0_evol,q,q0,nlp,num_bins,min_value,max_value):
	...
	return DH_hist,DA_hist,f_hist,phi_hist,de_hist,q_hist
